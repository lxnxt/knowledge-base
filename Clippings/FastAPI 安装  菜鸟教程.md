---
title: "FastAPI 安装 | 菜鸟教程"
source: "https://www.runoob.com/fastapi/fastapi-install.html"
author:
published:
created: 2026-08-08
description: "FastAPI 安装与环境配置 FastAPI 依赖 Python 3.8 及更高版本。本节介绍如何安装 FastAPI 以及配置开发环境。   检查 Python 版本 在安装 FastAPI 之前，先确认你的 Python 版本： $ python --version Python 3.11.0  # 或者 $ python3 --version Python 3.11.0 如果你的 Python 版本低于 3.8，请先升级 Pyt.."
tags:
  - "clippings"
---
## FastAPI 安装与环境配置
...
| [阿里 Qoder](https://qoder.cn/referral?utm_source=paid&utm_medium=affiliate&utm_campaign=cainiaojiaocheng) | 阿里推出的 AI 编程 IDE，基于 VS Code 深度定制 |
